...
namespace SimplifiedMoveset
{
    public static class BodyChunkConnectionMod
    {
        ...
        private static void BodyChunkConnection_Update(On.PhysicalObject.BodyChunkConnection.orig_Update orig, PhysicalObject.BodyChunkConnection bodyChunkConnection) // MainMod.Option_BellySlide // MainMod.Option_Crawl
        {
