...
1. Download the file  `SimplifiedMoveset.zip` from [Releases](https://github.com/SchuhBaum/SimplifiedMoveset/releases/tag/v2.3.8).
...
- (beam climb) Fixed a bug where the collision change would interfere with entering pipes close to the water surface.
